...
export const CheckoutProvider = ({ children }) => {
    ...
    return {
      ...
      async getPaymentMethods() {
        const paymentMethods =
          await api.shopperBaskets.getPaymentMethodsForBasket({
      ...
      async setPayment(payment) {
        ...
        console.log('checkout-context-split-start');
        const [expirationMonth, expirationYear] = expiry.split('/');
        console.log('checkout-context-split-end');
  ...
  return (
    <CheckoutContext.Provider value={ctx}>{children}</CheckoutContext.Provider>
  );
};
